...
export default function ProjectsPage() {
  ...
  async function handleProjectSubmit(projectData) {
    ...
    try {
      if (modal.project) {
        ...
        setProjects((current) =>
          current.map((project) =>
            getId(project) === getId(updatedProject)
              ? updatedProject
              : project
          )
        )
  ...
  async function handleDelete(project) {
    ...
    try {
      ...
      setProjects((current) =>
        current.filter((item) => getId(item) !== projectId)
      )
    ...
    <div className="content-container">
      <div className="page-heading">
        <div>
          ...
          <p className="page-subtitle">
            Manage your projects and keep communication organized.
          </p>
        </div>
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          message="Create a project to give your communication a home."
          action={
            <button
              className="button button-primary"
              type="button"
        ...
        <div className="project-card-grid">
          {projects.map((project) => (
            ...
            >
              ...
              >
                <span className="project-initial large">
              ...
              <div className="card-actions">
                ...
                <button
                  ...
                  type="button"
                  disabled={deletingProjectId === getId(project)}

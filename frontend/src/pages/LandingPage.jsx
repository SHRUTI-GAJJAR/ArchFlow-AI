    ...
    <main className="landing-page">
      ...
      <section className="landing-hero">
        <div className="hero-copy">
          ...
          <div className="hero-actions"><Link className="button button-primary button-large" to="/register">
  Get started <MoveRight size={18} strokeWidth={1.8} />
</Link>
<Link className="quiet-link" to="/login">Already have an account? Sign in</Link></div>
        </div>
